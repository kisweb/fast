...
MAX_NAME_CHAR = 15
MAX_MESSAGE_CHAR = 50
TIMESTAMP_FMT = "%d-%m-%Y %I:%M:%S %p UTC"
...
app, rt = fast_app(
    hdrs=(Link(rel="icon", type="assets/x-icon", href="/assets/taureau.png"),),
)
...
def render_content():
    ...
    return Div(
        ...
        Div(
            "Made with ❤️ by ",
            A("Kis@rrWeb", href="https://youtube.com/@ibrahimasarr1190", target="_blank"),
        ),
        Hr(),
        render_message_list(),
    )
